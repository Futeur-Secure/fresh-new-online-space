        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 text-sm font-medium mb-6">
              ...
              {plans.map((plan, i) => (
                <div 
                  ...
                  className={`relative group rounded-3xl p-8 backdrop-blur-xl border transition-all duration-300 hover:scale-105 hover:shadow-2xl ${
                    plan.popular 
                      ? 'bg-slate-700/40 border-slate-500/50 shadow-xl' 
                      : 'bg-slate-800/30 border-slate-700/40 hover:bg-slate-700/40'
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <div className="bg-gradient-to-r from-slate-400 to-slate-300 text-black px-4 py-1 rounded-full text-sm font-bold">
                        Most Popular
                      </div>
                    </div>
                  )}
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center">
                        <Check className="w-5 h-5 text-slate-400 mr-3 flex-shrink-0" />
                  ...
                  <button className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 ${
                    plan.popular
                      ? 'bg-slate-300 text-slate-900 hover:bg-slate-200 shadow-lg'
                      : 'bg-slate-700/60 hover:bg-slate-600/60 border border-slate-600/50 text-slate-200'
                  }`}>
                    Get Started
                  </button>
                </div>
